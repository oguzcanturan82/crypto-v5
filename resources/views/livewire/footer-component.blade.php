                    ...
                    <div class="wgs-footer wgs-contact">
                        ...
                        <div class="wgs-content">
                            <ul class="wgs-contact-list">
                                ...
                                <li><span class="pe pe-7s-global"></span>Email : <a href="mailto:info@sitename.com">info@sitename.com</a> <br/>Web : <a href="http://crypto.test">www.crypto.test</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- End Widget -->
        ...
        <div class="container">
            <div class="row">
                <div class="site-copy col-sm-7">
                    <p>Copyright &copy; 2022 CryptoCoin. Template Made by <a href="/">Pentasoft</a></p>
                </div>
